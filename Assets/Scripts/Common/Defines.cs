// Sabit değerleri içeren statik bir sınıf
public static class Defines
{
    public static readonly string OpenStartView = "OpenStartView"; // StartView'ı açma event'i
    public static readonly string OpenSettingsView = "OpenSettingsView"; // SettingsView'ı açma event'i
